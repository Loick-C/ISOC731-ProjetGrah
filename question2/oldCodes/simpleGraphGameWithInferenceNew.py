...
for i in range(1,n+1) :
    G.add_node(i,value=0,realValue=0,inference=(random.randrange(50,150))/100)
...
for i in range(0,n):
    ...
    if higherValue == 0 :
        ...
        G.node[randomNode]['value'] = G.node[randomNode]['realValue']*G.node[randomNode]['inference']
        
        G.node[nodeToConnect]['realValue'] = 1
        G.node[nodeToConnect]['value'] = G.node[nodeToConnect]['realValue']*G.node[nodeToConnect]['inference']
